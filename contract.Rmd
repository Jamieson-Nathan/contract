---
title: Jamieson's Grading Contract
...
- [ ] `r advdate(dayone, 4, topic)`
  - Finish Lab 3&4  by `r startweek`:  `r advdate(dayone, 4, assignment=startweek)`
...
- [ ] `r advdate(dayone, 6, topic)`
  - Finish Lab 5&6 by `r startweek`:  `r advdate(dayone, 6, assignment=startweek)`
...
- [ ] `r advdate(dayone, 8, topic)`
  - Finish Lab  7&8 by `r startweek`:  `r advdate(dayone, 8, assignment=startweek)`
...
- [ ] `r advdate(dayone, 10, topic)`
  - Finish Lab 9&10 by `r startweek`:  `r advdate(dayone, 10, assignment=startweek)`
